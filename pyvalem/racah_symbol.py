...
atom_k_term = integer.setResultsName('k_num') + pp.Suppress('/') + integer.setResultsName('k_den')

atom_j_term = integer.setResultsName('jterm')

racah_symbol_template = atom_principal + atom_orbital + pp.Suppress('[') + atom_k_term + pp.Suppress(']_') + atom_j_term
